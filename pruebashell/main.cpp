...
{
int v=i; int va; 
while(buf[v++]=='1'||buf[v++]=='2'||buf[v++]=='3'||buf[v++]=='4'||buf[v++]=='5'||buf[v++]=='6'||buf[v++]=='7'||buf[v++]=='8'||buf[v++]=='9'||buf[v++]=='0'){va=v;}; 
for(int o=(i+1);o<=va;o++){valvar[countvar]=valvar[countvar]+buf[o];}
}*/
...
//valnvar[countvar]=strtof((valvar[countvar]).c_str(),0);
...
//declarar polinomios general end


/*
//declarar polinomios de dos
for(int i=0;i<100;i++){int o=i+1;
if(buf[i]=='='&&buf[o]=='['){
for(int j=0;j<i;j++){varp[countpass]=varp[countpass]+buf[j];}
o++;
while(buf[o]=='1'||buf[o]=='2'||buf[o]=='3'||buf[o]=='4'||buf[o]=='5'||buf[o]=='6'||buf[o]=='7'||buf[o]=='8'||buf[o]=='9'||buf[o]=='0'){o++;};
for(int j=i+2;j<o;j++){valvarp[countpass][countvarp]=valvarp[countpass][countvarp]+buf[j];}
//valnvar[countvar]=strtof((valvar[countvar]).c_str(),0);
valnvarp[countpass][countvarp]=atoi(valvarp[countpass][countvarp].c_str());
countvarp++;
int m=o+1;
while(buf[m]=='1'||buf[m]=='2'||buf[m]=='3'||buf[m]=='4'||buf[m]=='5'||buf[m]=='6'||buf[m]=='7'||buf[m]=='8'||buf[m]=='9'||buf[m]=='0'){m++;};
for(int j=o+1;j<m;j++){valvarp[countpass][countvarp]=valvarp[countpass][countvarp]+buf[j];}
valnvarp[countpass][countvarp]=atoi(valvarp[countpass][countvarp].c_str());
i=100;
countpass++;
countvarp--;
...
//declarar polinomios end de dod
...
//multiplicacion de polinomios end


//valnvar[countvar]=strtof((valvar[countvar]).c_str(),0);
//cout<<valvar[countvar]<<endl;
if(buf[0]=='s'&&buf[1]=='h'&&buf[2]=='o'&&buf[3]=='w'&&buf[4]!='p'){for(int i=0;i<countvar;i++){cout<<var[i]<<"="<<valnvar[i]<<endl;}cout<<endl;}
if(buf[0]=='c'&&buf[1]=='l'&&buf[2]=='c'){system("cls");}
if(buf[0]=='c'&&buf[1]=='l'&&buf[2]=='e'&&buf[3]=='a'&&buf[4]=='r'&&buf[5]!='p'){for(int i=0;i<100;i++){var[i]="";}countvar=0;}
                  
if(buf[0]=='s'&&buf[1]=='h'&&buf[2]=='o'&&buf[3]=='w'&&buf[4]=='p'){ for(int j=0;j<countpass;j++){cout<<varp[j]<<" = [ ";
                                                                     for(int i=0;i<countnumvarp[j];i++){cout<<valnvarp[j][i]<<" ";} cout<<"] "<<endl;}cout<<endl;}
if(buf[0]=='c'&&buf[1]=='l'&&buf[2]=='e'&&buf[3]=='a'&&buf[4]=='r'&&buf[5]=='p'){ for(int j=0;j<countpass;j++){varp[countpass]="";
                                                                                  for(int i=0;i<countvarp;i++){valnvarp[countpass][i]=0;}}countvarp=0;countpass=0;}
